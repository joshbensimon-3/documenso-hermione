...
export const DocumentSigningDateField = ({
  ...
  return (
    ...
    >
      ...
      {!field.inserted && (
        <p className="text-[clamp(0.425rem,12cqw,0.825rem)] text-foreground duration-200 group-hover:text-primary group-hover:text-recipient-green">
          <Trans>Date</Trans>
        </p>
      )}
      ...
      {field.inserted && (
        <div className="flex h-full w-full items-center">
          <p
            className={cn(
              'w-full whitespace-normal break-words text-left text-[clamp(0.425rem,12cqw,0.825rem)] text-foreground duration-200',
              {
